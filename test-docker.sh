...
RESULT='[{"disambiguatedURL":"http:\/\/dbpedia.org\/resource\/Angela_Merkel","offset":13,"namedEntity":"Angela Merkel","start":1},{"disambiguatedURL":"http:\/\/dbpedia.org\/resource\/Barack_Obama","offset":12,"namedEntity":"Barack Obama","start":19},{"disambiguatedURL":"http:\/\/dbpedia.org\/resource\/Berlin","offset":6,"namedEntity":"Berlin","start":39}]\c'
