...
public class TextDisambiguation {
    ...
    public static void main(String[] args) throws IOException {
        String TestFile = "german_corpus.xml";// "500newsgoldstandard.xml" "reuters.xml"
        ...
        for (int maxDepth = 1; maxDepth <= 3; ++maxDepth) {
            BufferedWriter bw = new BufferedWriter(new FileWriter("Test_" + TestFile + "_" + maxDepth + ".txt"));
