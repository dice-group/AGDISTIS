...
public class CandidateUtil {
  ...
  public CandidateUtil() throws IOException {
    ...
    final String envPopularity = System.getenv("AGDISTIS_POPULARITY");
    popularity =
        Boolean.valueOf(envPopularity != null ? envPopularity : prop.getProperty("popularity"));
    final String envAcronym = System.getenv("AGDISTIS_ACRONYM");
    acronym = Boolean.valueOf(envAcronym != null ? envAcronym : prop.getProperty("acronym"));
    final String envCommonEntities = System.getenv("AGDISTIS_COMMON_ENTITIES");
    commonEntities = Boolean.valueOf(
        envCommonEntities != null ? envCommonEntities : prop.getProperty("commonEntities"));
